...
//
//     final googlemappolylineapi = googlemappolylineapiFromJson(jsonString);

import 'dart:convert';

Googlemappolylineapi googlemappolylineapiFromJson(String str) =>
    Googlemappolylineapi.fromJson(json.decode(str));

String googlemappolylineapiToJson(Googlemappolylineapi data) =>
    json.encode(data.toJson());

class Googlemappolylineapi {
  Googlemappolylineapi({
  ...
  factory Googlemappolylineapi.fromJson(Map<String, dynamic> json) =>
      Googlemappolylineapi(
